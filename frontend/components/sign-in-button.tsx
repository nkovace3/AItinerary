...
function GoogleIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 18 18" aria-hidden="true" {...props}>
            ...
            <path
                fill="#EA4335"
                d="M9 3.5795c1.3214 0 2.5077.4541 3.4405 1.346l2.5814-2.5814C13.4632.8918 11.426 0 9 0 5.4818 0 2.4382 2.0168.9573 4.9582L3.9641 7.29C4.6718 5.1627 6.6564 3.5795 9 3.5795z"
            />
        </svg>
    );
}
...
export function SignInButton({ className }: { className?: string }) {
    ...
    return (
        <Button
            ...
            className={cn("gap-3 text-foreground", className)}
        >
